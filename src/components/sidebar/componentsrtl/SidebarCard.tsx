  ...
  return (
    <div className="relative mt-14 flex w-[256px] justify-center rounded-[20px] bg-gradient-to-br from-[#868CFF] via-[#432CF3] to-brand-500 pb-4">
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        <p className="text-lg font-bold text-white">Wallet Management</p>
        <p className="mt-1 mb-1 px-4 text-center text-sm text-white">
        Click the button underneath to enter your wallet menu or log out.
</p>
       <ConnectWallet/>
      </div>
    </div>
